    ...
    public AliyunGreenTemplate(GreenProperties greenProperties) {
        ...
        try {
            IClientProfile profile = DefaultProfile
                    .getProfile("cn-hangzhou", greenProperties.getAccessKeyID(), greenProperties.getAccessKeySecret());
            DefaultProfile
                    .addEndpoint("cn-hangzhou", "cn-hangzhou", "Green", "oss-cn-hangzhou.aliyuncs.com");
